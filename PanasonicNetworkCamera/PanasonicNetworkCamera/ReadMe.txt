========================================================================
    コンソール アプリケーション: PanasonicNetworkCamera プロジェクトの概要
========================================================================

この PanasonicNetworkCamera アプリケーションは、AppWizard により作成されました。

このファイルには、PanasonicNetworkCamera 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


PanasonicNetworkCamera.vcxproj
...
PanasonicNetworkCamera.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、PanasonicNetworkCamera.pch 
