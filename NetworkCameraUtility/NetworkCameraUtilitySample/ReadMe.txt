========================================================================
    コンソール アプリケーション: NetworkCameraUtilitySample プロジェクトの概要
========================================================================

この NetworkCameraUtilitySample アプリケーションは、AppWizard により作成されました。

このファイルには、NetworkCameraUtilitySample 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


NetworkCameraUtilitySample.vcxproj
...
NetworkCameraUtilitySample.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、NetworkCameraUtilitySample.pch 
