========================================================================
    コンソール アプリケーション: SonyNetworkCamera プロジェクトの概要
========================================================================

この SonyNetworkCamera アプリケーションは、AppWizard により作成されました。

このファイルには、SonyNetworkCamera 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


SonyNetworkCamera.vcxproj
...
SonyNetworkCamera.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、SonyNetworkCamera.pch 
